...
export const CLAIMS = Object.freeze([
  ...
  { id: 'claim-heat-hunts', dimension: 'trigger',
    ...
    truth: true, supportedBy: ['survivor-account', 'thermal-void', 'frost-bloom', 'lantern-pair', 'chart-recorder', 'hot-works-permit', 'tubular-heaters'] },
  { id: 'claim-gradient-blocks', dimension: 'constraint',
    text: 'A sustained heat gradient above 40C stops it dead.',
    truth: true, supportedBy: ['frost-boundary', 'frost-bloom', 'ambulance-transcript', 'accident-book'] },
  ...
  { id: 'claim-thermal-visible', dimension: 'form',
    ...
    truth: true, supportedBy: ['thermal-void', 'crew-imager', 'fire-watch-camera'] },
  { id: 'claim-drains-batteries', dimension: 'capability',
    text: 'It drains battery-powered equipment near it.',
    truth: true, supportedBy: ['battery-drain', 'spent-cells', 'alarm-cells'] },
